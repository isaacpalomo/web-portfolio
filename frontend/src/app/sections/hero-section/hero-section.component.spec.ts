...
describe("HeroSectionComponent", () => {
  ...
  it("renders bound hero copy and resume link", () => {
    ...
    const resume = el.querySelector('a[download]') as HTMLAnchorElement | null;
    expect(resume?.getAttribute("href")).toBe("assets/cv.pdf");
  });
});
